function GameManager(size, InputManager, Actuator, StorageManager, contractName, contractAddress) {
  ...
  this.inputManager.on("checkScore", this.checkScore.bind(this));
  this.inputManager.on("submitLoginInfo", this.submitLoginInfo.bind(this));
  this.inputManager.on("cancelButton", this.cancelButton.bind(this));
...
// Check high score
GameManager.prototype.checkScore = function () {
  this.actuator.clearMessage();
  this.actuator.openModal();
}
...
GameManager.prototype.cancelButton = function () {
  this.actuator.message(true);
  this.actuator.closeModal();
}
